...
export declare class MtxPopoverTrigger implements AfterContentInit, OnDestroy {
  ...
  static ɵfac: i0.ɵɵFactoryDeclaration<
    MtxPopoverTrigger,
    [null, null, null, null, { optional: true }, null, null]
  >;
  static ɵdir: i0.ɵɵDirectiveDeclaration<
    ...
    ['mtxPopoverTrigger'],
    {
      popover: { alias: 'mtxPopoverTriggerFor'; required: false };
      popoverData: { alias: 'mtxPopoverTriggerData'; required: false };
      targetElement: { alias: 'mtxPopoverTargetAt'; required: false };
      triggerEvent: { alias: 'mtxPopoverTriggerOn'; required: false };
    },
    { popoverOpened: 'popoverOpened'; popoverClosed: 'popoverClosed' },
    never,
    never,
    true,
    never
