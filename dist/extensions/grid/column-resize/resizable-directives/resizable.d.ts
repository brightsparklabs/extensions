...
export declare class MatResizable extends AbstractMatResizable {
  ...
  constructor(
    ...
    eventDispatcher: HeaderRowEventDispatcher,
    injector: Injector,
    ngZone: NgZone,
    overlay: Overlay,
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<
    MatResizable,
    'mat-header-cell[resizable], th[mat-header-cell][resizable]',
    never,
    {
      minWidthPx: { alias: 'matResizableMinWidthPx'; required: false };
      maxWidthPx: { alias: 'matResizableMaxWidthPx'; required: false };
      resizable: { alias: 'resizable'; required: false };
    },
    {},
    never,
    never,
