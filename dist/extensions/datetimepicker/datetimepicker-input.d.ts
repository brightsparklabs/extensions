...
export declare class MtxDatetimepickerInput<D>
  implements AfterContentInit, ControlValueAccessor, OnDestroy, Validator
{
  ...
  static ɵfac: i0.ɵɵFactoryDeclaration<
    MtxDatetimepickerInput<any>,
    [null, { optional: true }, { optional: true }, { optional: true }]
  >;
  static ɵdir: i0.ɵɵDirectiveDeclaration<
    MtxDatetimepickerInput<any>,
    'input[mtxDatetimepicker]',
    ['mtxDatetimepickerInput'],
    {
      mtxDatetimepicker: { alias: 'mtxDatetimepicker'; required: false };
      mtxDatetimepickerFilter: { alias: 'mtxDatetimepickerFilter'; required: false };
